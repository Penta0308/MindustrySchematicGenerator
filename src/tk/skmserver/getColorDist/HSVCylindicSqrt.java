...
public class HSVCylindicSqrt implements ColorDist {
    @Override
    public double getDist(int i, int i1) {
        ...
        double d1 = (s1 * Math.cos(2 * Math.PI * h1 / 255.0d)) + (s2 * Math.cos(2 * Math.PI * h2 / 255.0d));
        double d2 = (s1 * Math.sin(2 * Math.PI * h1 / 255.0d)) + (s2 * Math.sin(2 * Math.PI * h2 / 255.0d));
        double d3 = v1 - v2;
